...
const ACCENT = "text-[#0056A6]";
const ACCENT_BG = "bg-[#0056A6]";
		...
		<nav
			...
			<div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 lg:px-8">
							...
							<motion.div
								...
								<Link
									...
									className={[
										...
										active ? ACCENT : "text-black hover:text-[#0056A6]",
									].join(" ")}>
									{link.label}
								</Link>
				...
				<button
					...
					className="inline-flex items-center justify-center rounded-md p-2 text-slate-700 hover:bg-slate-100 lg:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0056A6]"
